  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-accent/30 relative overflow-hidden">
      ...
      <section className="py-20 px-4 relative z-10">
        <div className="container mx-auto text-center">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gradient-primary font-display animate-slide-up animate-delay-500 leading-tight">
              Plateau State Polytechnic Barkin Ladi
            </h1>
            <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-foreground font-display animate-slide-up animate-delay-600">
              School of Information and Communication Technology
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-slide-up animate-delay-700 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="flex justify-center mb-12 animate-scale-in animate-delay-800">
            <Button asChild size="lg" className="bg-gradient-to-r from-polytechnic-blue to-polytechnic-green hover:shadow-lg transition-all duration-300 hover-lift text-base px-6 py-4 animate-glow-pulse">
      ...
      <section className="py-16 px-4 relative z-10">
        <div className="container mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12 text-gradient-primary font-display animate-slide-up animate-delay-200">System Features</h3>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-polytechnic-blue to-polytechnic-green relative overflow-hidden">
        ...
        <div className="container mx-auto text-center text-white relative z-10">
          <h3 className="text-3xl font-bold mb-6 font-display animate-slide-up animate-delay-200">Contact Information</h3>
